...
To get rid of a filter, the user can delete the information in the input box and press enter, or refresh the entire table by clicking on the UFO Sightings text on the top of the webpage (displayed below). The table filters based on current values in the input boxes, so deleting the values also deletes the filter placed on the data.

<img width="725" alt="Screen Shot 2021-07-10 at 4 54 49 PM" src="https://user-images.githubusercontent.com/83552696/125179072-99b8b200-e19f-11eb-9954-9de4e05a292a.png">
